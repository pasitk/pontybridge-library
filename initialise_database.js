...
function addData() {
    // Editted: add number of copies to each book to make a book to be able to have more than 1 copy.
    // and add 'returned' flag to each loan to make the loan can be kept after book returning, without deleting that loan.
